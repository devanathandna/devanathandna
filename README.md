...
**💻 Tech Stack:** `Python` `Scikit-Learn` `Pandas` `NumPy` `Matplotlib` `Seaborn` `XGBoost` `CatBoost`
...
- 🐍 **Python For AI** - IBM (2023)
- 🌐 **Basics of Computer Networks** - CISCO (2024)
- 🧠 **Natural Language Processing (NLP) and Text Mining Tutorial for Beginners** - Simplilearn (2024)
- 📊 **Mastering Data Structures and Algorithms** - Udemy (2023)
- 🔒 **Cybersecurity Compliance Framework & System Administration** - IBM, Coursera (2024)
- 🤖 **Supervised Machine Learning: Regression and Classification** - Stanford, Coursera (2024)
- 💼 **JPMorgan Virtual Job Simulation on Forage for Cybersecurity** (2024)
